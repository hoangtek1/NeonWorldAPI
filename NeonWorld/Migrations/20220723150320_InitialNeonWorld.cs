...
{
    public partial class InitialNeonWorld : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<Guid>(nullable: false),
                    ProductId = table.Column<int>(nullable: false),
                    UserComment = table.Column<string>(maxLength: 1000, nullable: false),
                    DateCreated = table.Column<DateTime>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipAddress = table.Column<string>(maxLength: 300, nullable: false),
                    ShipEmail = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
                    ShipPhoneNumber = table.Column<string>(type: "varchar(10)", nullable: false),
                    ShipNote = table.Column<string>(maxLength: 1000, nullable: false),
